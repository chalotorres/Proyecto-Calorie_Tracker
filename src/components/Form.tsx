...
export default function Form() {
    ...
    const handleChange = (e : ChangeEvent<HTMLSelectElement> | ChangeEvent<HTMLInputElement>) => {
        const isnNumberField = ['category', 'calories'].includes(e.target.id)
        
        setActivity({
            ...activity,
            [e.target.id] : isnNumberField ? +e.target.value : e.target.value,
        })
    }
    ...
    return (
        <form className="space-y-5 bg-white shadow p-10 rounded-lg">
            ...
            <input type="submit"
                ...
                value="Guardar Comida o Guardar ejercicio" id="" />
        </form>
    )
}
